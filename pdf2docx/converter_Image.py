...
class Converter_Image:
    ...
    * Finally, generate docx with ``python-docx``.
    ...
    def __init__(self, pdf_file:str, password:str=None):
        ...
        self._pages = Pages()
        self.json_converter_result_list=[]
    ...
    def default_settings(self):
        ...
        return {
            ...
            'line_break_width_ratio'         : 0.1,    # break line if the ratio of line width to entire layout bbox is lower than this value
            # 'line_break_free_space_ratio'    : 0.1,    # break line if the ratio of free space to entire line exceeds this value
            'line_break_free_space_ratio'    : 0.5,    # break line if the ratio of free space to entire line exceeds this value
            ...
            'lines_left_aligned_threshold'   : 2.0,    # left aligned if d_x0 of two lines is lower than this value (Pt)
            'lines_right_aligned_threshold'  : 2.0,    # right aligned if d_x1 of two lines is lower than this value (Pt)
            ...
            'img_to_convert_docx': True  # add new settings
        }
    ...
    def load_pages(self, start:int=0, end:int=None, pages:list=None):
        ...
        ## Convert the PDF first and extract each page
        ...
        # If the PDF is encrypted, decode it
        ...
        num = len(self._fitz_doc)         # Number of pages in the PDF
    ...
    def parse_document(self, **kwargs):
        ...
        ## Parse the PDF to extract text, images, tables, and some shapes (lines, filled shapes)
        logging.info(self._color_output('[2/4] Analyzing document...'))

        self._pages.parse_images(self.json_converter_result_list,self.fitz_doc,self.filename_pdf, **kwargs)  ## Convert the images
        return self
    ...
    def make_docx(self, docx_filename=None, **kwargs):
        ...
        # Create page-by-page and write into a docx file
        docx_file = Document() 
        ...
        for i, page in enumerate(parsed_pages, start=1):
            ...
            # docx_file.save('./test_data/test.docx')   ### Completed conversion for the first page
    ...
    def convert(self,json_converter_result_list, docx_filename:str=None, start:int=0, end:int=None, pages:list=None, **kwargs):
        ...
        self.json_converter_result_list=json_converter_result_list
    ...
    def _parse_pages_per_cpu(vector):
        ...
        cv = Converter_Image(pdf_filename, password)
        cv.load_pages()
